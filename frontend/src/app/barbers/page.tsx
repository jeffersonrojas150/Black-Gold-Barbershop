              ...
              {barbers.map((barber) => (
                <Card key={barber.id} className="overflow-hidden hover:scale-105 transition-transform">
                  <div className="relative h-64">
                    <img src={barber.image_url || 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500'} alt={barber.name} className="w-full h-full object-cover" />
                  ...
                  <div className="p-6">
                    <div className="inline-block px-3 py-1 rounded-full text-xs font-medium mb-3 border" style={{ backgroundColor: 'rgba(212, 175, 55, 0.2)', color: 'var(--color-primary)', borderColor: 'var(--color-primary)' }}>
                    ...
                    <Link href="/appointments/new" className="block text-center px-4 py-2 rounded-lg text-sm font-medium transition-colors hover:opacity-90" style={{ backgroundColor: 'var(--color-primary)', color: 'var(--color-dark)' }}>
    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-dark)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link href="/services" className="text-gray-300 hover:text-white transition-colors font-light">Servicios</Link>
              <Link href="/barbers" className="text-yellow-400 font-light">Barberos</Link>
            ...
            <button onClick={() => { const menu = document.getElementById('mobile-menu-barbers'); if (menu) menu.classList.toggle('hidden'); }} className="md:hidden p-2 rounded-lg" style={{ color: 'var(--color-primary)' }}>
          ...
          <div id="mobile-menu-barbers" className="hidden md:hidden pb-4 border-t mt-2" style={{ borderColor: 'var(--color-dark-lighter)' }}>
            <div className="flex flex-col space-y-3 pt-4">
              ...
              <Link href="/services" className="text-gray-300 hover:text-white transition-colors font-light py-2">Servicios</Link>
              <Link href="/barbers" className="text-yellow-400 font-light py-2">Barberos</Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {barbers.map((barber) => (
              <Card key={barber.id} className="overflow-hidden hover:scale-105 transition-transform">
                ...
                <div className="p-6">
                  ...
                  <Link href="/register" className="block text-center px-4 py-2 rounded-lg text-sm font-medium transition-colors hover:opacity-90" style={{ backgroundColor: 'var(--color-primary)', color: 'var(--color-dark)' }}>
                    Reservar con {barber.name.split(' ')[0]}
                  </Link>
                </div>
              </Card>
        ...
        <div className="mt-16 p-8 rounded-2xl text-center border-2" style={{ backgroundColor: 'var(--color-dark-light)', borderColor: 'var(--color-primary)' }}>
          <h2 className="text-3xl font-bold text-white mb-4">Reserva con tu barbero favorito</h2>
          <p className="text-gray-400 font-light mb-6">Elige el profesional que mejor se adapte a tu estilo</p>
          <Link href="/register" className="inline-block px-8 py-4 text-lg font-medium rounded-lg transition-all hover:scale-105" style={{ backgroundColor: 'var(--color-primary)', color: 'var(--color-dark)' }}>
            Comenzar Ahora
          </Link>
        </div>
      </div>
